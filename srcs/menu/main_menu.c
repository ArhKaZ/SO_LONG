...
/*   Updated: 2023/03/13 16:52:53 by syluiset         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/so_long.h"

int	close_cross(t_param *param)
{
	close_menu_exit(param, param->menu->mlx->mlx,
		param->menu->mlx->mlx_win, param->mlx->mlx);
	return (0);
}
...
int	main_menu(t_param *param)
{
	...
	free(place);
	mlx_hook(param->menu->mlx->mlx_win, 17, 1L >> 0, &close_cross, param);
